...
class ListMentorsWindowVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    //MARK: Properties
    private let listMentorsTable: UITableView = {
        let tv = UITableView()
    ...
    override func viewDidLoad() {
        ...
        self.view.addSubview(listMentorsTable)
    ...
    //MARK: Methods
    func editTableView() {
        self.listMentorsTable.delegate = self
        self.listMentorsTable.dataSource = self
        self.listMentorsTable.backgroundColor = UIColor.cyanCustom
        self.listMentorsTable.register(ListMentorsCell.self, forCellReuseIdentifier: ListMentorsCell.idCell)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = listMentorsTable.dequeueReusableCell(withIdentifier: ListMentorsCell.idCell, for: indexPath) as! ListMentorsCell
    ...
    private func anchorConstraint() {
        //project table
        self.listMentorsTable.topAnchor.constraint(equalTo: self.view.topAnchor).isActive = true
        self.listMentorsTable.leadingAnchor.constraint(equalTo: self.view.leadingAnchor).isActive = true
        self.listMentorsTable.trailingAnchor.constraint(equalTo: self.view.trailingAnchor).isActive = true
        self.listMentorsTable.bottomAnchor.constraint(equalTo: self.view.bottomAnchor).isActive = true
    }
}

class ListMentorsCell: UITableViewCell {
    
    //MARK: Properties
    static let idCell = "listMentorsCellIdentifier"
