...
class ListCuratorsWindowVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    //MARK: Properties
    private let listCuratorsTable: UITableView = {
        let tv = UITableView()
    ...
    override func viewDidLoad() {
        ...
        self.view.addSubview(listCuratorsTable)
    ...
    //MARK: Methods
    func editTableView() {
        self.listCuratorsTable.delegate = self
        self.listCuratorsTable.dataSource = self
        self.listCuratorsTable.backgroundColor = UIColor.cyanCustom
        self.listCuratorsTable.register(ListCuratorsCell.self, forCellReuseIdentifier: ListCuratorsCell.idCell)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = listCuratorsTable.dequeueReusableCell(withIdentifier: ListCuratorsCell.idCell, for: indexPath) as! ListCuratorsCell
    ...
    private func anchorConstraint() {
        //project table
        self.listCuratorsTable.topAnchor.constraint(equalTo: self.view.topAnchor).isActive = true
        self.listCuratorsTable.leadingAnchor.constraint(equalTo: self.view.leadingAnchor).isActive = true
        self.listCuratorsTable.trailingAnchor.constraint(equalTo: self.view.trailingAnchor).isActive = true
        self.listCuratorsTable.bottomAnchor.constraint(equalTo: self.view.bottomAnchor).isActive = true
    }
}

class ListCuratorsCell: UITableViewCell {
    
    //MARK: Properties
    static let idCell = "listCuratorsCellIdentifier"
