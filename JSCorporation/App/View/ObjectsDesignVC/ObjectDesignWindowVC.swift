...
class ObjectDesignWindowVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    //MARK: Properties
    private let objectDesignLabel: UILabel = {
        let lbl = UILabel()
        lbl.translatesAutoresizingMaskIntoConstraints = false
        lbl.text = "Объекты дизайна"
        return lbl
    }()
    ...
    private let objectDesignTable: UITableView = {
        let tv = UITableView()
    ...
    override func viewDidLoad() {
        ...
        self.view.addSubview(objectDesignLabel)
        self.view.addSubview(downloadAllFiles)
        self.view.addSubview(objectDesignTable)
    ...
    //MARK: Methods
    func editTableView() {
        self.objectDesignTable.delegate = self
        self.objectDesignTable.dataSource = self
        self.objectDesignTable.backgroundColor = UIColor.lightBlackCustom
        self.objectDesignTable.register(ObjetDesignCell.self, forCellReuseIdentifier: ObjetDesignCell.idCell)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = objectDesignTable.dequeueReusableCell(withIdentifier: ObjetDesignCell.idCell, for: indexPath) as! ObjetDesignCell
    ...
    private func anchorConstraint() {
        ...
        //source code label
        self.objectDesignLabel.topAnchor.constraint(equalTo: self.view.topAnchor, constant: 10).isActive = true
        self.objectDesignLabel.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 10).isActive = true
        self.objectDesignLabel.trailingAnchor.constraint(equalTo: self.view.trailingAnchor, constant: -10).isActive = true
        self.objectDesignLabel.heightAnchor.constraint(equalToConstant: 25).isActive = true
        ...
        //source code table
        self.objectDesignTable.trailingAnchor.constraint(equalTo: self.view.trailingAnchor).isActive = true
        self.objectDesignTable.topAnchor.constraint(equalTo: self.objectDesignLabel.bottomAnchor, constant: 10).isActive = true
        self.objectDesignTable.leadingAnchor.constraint(equalTo: self.view.leadingAnchor).isActive = true
        self.objectDesignTable.bottomAnchor.constraint(equalTo: self.downloadAllFiles.topAnchor, constant: -10).isActive = true
    }
}

class ObjetDesignCell: UITableViewCell {
    
    //MARK: Properties
    static let idCell = "ObjetDesignCellIdentifier"
