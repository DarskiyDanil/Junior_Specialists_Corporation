//
//  ListsSpecialistsWindowVC.swift
//  JSCorporation
//
//  Created by Борис Павлов on 22/07/2019.
//  Copyright © 2019 Boris. All rights reserved.
//

import UIKit

class ListsSpecialistsWindowVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    //MARK: Properties
    private let listSpecialistsTable: UITableView = {
        let tv = UITableView()
    ...
    override func viewDidLoad() {
        ...
        self.view.addSubview(listSpecialistsTable)
    ...
    //MARK: Methods
    func editTableView() {
        self.listSpecialistsTable.delegate = self
        self.listSpecialistsTable.dataSource = self
        self.listSpecialistsTable.backgroundColor = UIColor.cyanCustom
        self.listSpecialistsTable.register(ListSpecialistsCell.self, forCellReuseIdentifier: ListSpecialistsCell.idCell)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = listSpecialistsTable.dequeueReusableCell(withIdentifier: ListSpecialistsCell.idCell, for: indexPath) as! ListSpecialistsCell
    ...
    private func anchorConstraint() {
        //project table
        self.listSpecialistsTable.topAnchor.constraint(equalTo: self.view.topAnchor).isActive = true
        self.listSpecialistsTable.leadingAnchor.constraint(equalTo: self.view.leadingAnchor).isActive = true
        self.listSpecialistsTable.trailingAnchor.constraint(equalTo: self.view.trailingAnchor).isActive = true
        self.listSpecialistsTable.bottomAnchor.constraint(equalTo: self.view.bottomAnchor).isActive = true
    }
}

class ListSpecialistsCell: UITableViewCell {
    
    //MARK: Properties
    static let idCell = "listSpecialistsCellIdentifier"
