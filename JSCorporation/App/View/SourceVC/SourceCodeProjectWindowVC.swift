//
//  SourceCodeProjectWindowVC.swift
//  JSCorporation
//
...
class SourceCodeProjectWindowVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private let sourceCodeProjectTable: UITableView = {
        let tv = UITableView()
    ...
    override func viewDidLoad() {
        ...
        self.view.addSubview(sourceCodeProjectTable)
    ...
    //MARK: Methods
    func editTableView() {
        self.sourceCodeProjectTable.delegate = self
        self.sourceCodeProjectTable.dataSource = self
        self.sourceCodeProjectTable.backgroundColor = UIColor.lightBlackCustom
        self.sourceCodeProjectTable.register(SourceCodeProjectCell.self, forCellReuseIdentifier: SourceCodeProjectCell.idCell)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = sourceCodeProjectTable.dequeueReusableCell(withIdentifier: SourceCodeProjectCell.idCell, for: indexPath) as! SourceCodeProjectCell
    ...
    private func anchorConstraint() {
        ...
        //document table
        self.sourceCodeProjectTable.trailingAnchor.constraint(equalTo: self.view.trailingAnchor).isActive = true
        self.sourceCodeProjectTable.topAnchor.constraint(equalTo: self.myProjectLabel.bottomAnchor, constant: 10).isActive = true
        self.sourceCodeProjectTable.leadingAnchor.constraint(equalTo: self.view.leadingAnchor).isActive = true
        self.sourceCodeProjectTable.bottomAnchor.constraint(equalTo: self.editProjecSourceCodet.topAnchor, constant: -10).isActive = true
    }
}

class SourceCodeProjectCell: UITableViewCell {
    
    //MARK: Properties
    static let idCell = "SourceCodeProjectCellIdentifier"
