...
class MyDocumentsWindowVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    //MARK: Properties
    private let myDocumentLabel: UILabel = {
        let lbl = UILabel()
        lbl.translatesAutoresizingMaskIntoConstraints = false
        lbl.text = "Мои документы / International Science Hub:"
        return lbl
    }()
    ...
    func editTableView() {
        ...
        self.documentTable.register(MyDocumentCell.self, forCellReuseIdentifier: MyDocumentCell.idCell)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = documentTable.dequeueReusableCell(withIdentifier: MyDocumentCell.idCell, for: indexPath) as! MyDocumentCell
...
class MyDocumentCell: UITableViewCell {
    
    //MARK: Properties
    static let idCell = "MyDocumentCellIdentifier"
