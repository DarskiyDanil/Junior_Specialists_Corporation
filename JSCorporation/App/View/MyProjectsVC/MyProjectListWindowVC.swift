...
class MyProjectListWindowVC: UIViewController, UITableViewDelegate, UITableViewDataSource, UIGestureRecognizerDelegate {
    ...
    func editTableView() {
        ...
        self.projectTable.register(MyProjectCell.self, forCellReuseIdentifier: MyProjectCell.idCell)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = projectTable.dequeueReusableCell(withIdentifier: MyProjectCell.idCell, for: indexPath) as! MyProjectCell
...
class MyProjectCell: UITableViewCell {
    
    //MARK: Properties
    static let idCell = "MyProjectCellIdentifier"
